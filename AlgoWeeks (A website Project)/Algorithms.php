...
<div class="header">
  <h1>Algorithms & Concepts</h1>
</div>
<ul>
  <li><a href="home.php">Home</a></li>
  <li><a href="Code Library.php">Code Library</a></li>
  <li><a class="active" href="Algorithms.php">Algorithms & Concepts</a></li>
...
<div class="row">
  ...
  <div class="card">
      <?php
        ...
        $type="Algorithm & Concepts";
        $sql = "SELECT id, user, post, name, time FROM blog WHERE type='$type';";
